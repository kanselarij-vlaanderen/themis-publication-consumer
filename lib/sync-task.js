...
const TASK_NOT_STARTED_STATUS = 'http://kanselarij.vo.data.gift/services/themis-publication-consumer/sync-task-statuses/not-started';
const TASK_ONGOING_STATUS = 'http://kanselarij.vo.data.gift/services/themis-publication-consumer/sync-task-statuses/ongoing';
const TASK_SUCCESS_STATUS = 'http://kanselarij.vo.data.gift/services/themis-publication-consumer/sync-task-statuses/success';
const TASK_FAILED_STATUS = 'http://kanselarij.vo.data.gift/services/themis-publication-consumer/sync-task-statuses/failed';
